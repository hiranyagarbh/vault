...
Build a simple expense tracker application to manage your finances. The application should :
- Allow users to add, delete, and view their expenses. 
- Provide a summary of the expenses.
## Requirements
